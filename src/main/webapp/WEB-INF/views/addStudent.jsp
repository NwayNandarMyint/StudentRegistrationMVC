...
<body>
    ...
    <div id="sub_content">
    	<form:form action="/StudentRegistrationMvc/student/addStudent" method="post"  modelAttribute="student" enctype="multipart/form-data">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            <form:input type="number" path="phone" class="form-control" placeholder="Enter Phone Number"/>
        </div>
    </div>
    <div class="row mb-4">
        <div class="col-md-2"></div>
    ...
    <div class="row mb-4">
    	<div class="col-md-2"></div>
    	<label for="courses" class="col-md-2 col-form-label">Course</label>
    	<div class="col-md-4" style="color:black;font-size:17px;">
        	<form:checkboxes items="${courses}" path="courses" itemLabel="name" itemValue="id"/>
    	</div>
	</div>
...
<div class="row mb-4">
              <div class="col-md-2" ></div>
                <label class="col-form-label col-md-2" style="color:black;">Attend</label>
                <div class='col-md-4'>
