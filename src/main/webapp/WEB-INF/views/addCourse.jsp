...
<body>
	...
	<div class="main_contents">
		...
		<div id="sub_content">
			...
			<form:form  action="/StudentRegistrationMvc/course/addCourse" method="post" modelAttribute="course">
				 <div class="row">
				...
				<div class="row mb-4">
					...
					<div class="col-md-4">
						...
						<form:input type="text" class="form-control" id="name" autofocus="autofocus" path="name" placeholder="Course Name" /><br>
				...
				<div class="row mb-4">
					...
					<div class="col-md-6">
						...
						<button type="submit" class="btn btn-secondary col-md-2"
							data-bs-toggle="modal" data-bs-target="#exampleModa">Add</button>
						</div>
			 ...
			 <div class="popup" id="popup">
		                ...
		                <a href="/StudentRegistrationMvc/course/displayCourse"><button type="button">Ok</button></a>
           		  </div>
