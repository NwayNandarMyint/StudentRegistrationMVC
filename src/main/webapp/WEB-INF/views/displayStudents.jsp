...
<body>
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${sutdents}" var="student">
                            <tr>
                                ...
                                <a href="/StudentRegistrationMvc/student/viewStudent/${student.id}"><button type="button" class="btn btn-secondary">SeeMore</button></a>
                                <button type="button" class="btn btn-secondary" onclick="openDeleteModal(${student.id})">Delete</button>
    ...
    <div class="container-delete">    
        ...
        <c:otherwise>
            ...
            <div>
                <table class="table table-striped width:40%" id="studentTable">
                    <thead>
                        <tr>
