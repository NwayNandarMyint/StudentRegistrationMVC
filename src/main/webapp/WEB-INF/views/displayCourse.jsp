...
.dataTables_filter {
 margin-bottom: 10px;
    ...
    left: 70%; /* Move filter to the center horizontally */
                    ...
                    <c:forEach var="course" items="${courses}">
                        <c:if test="${course.name != null}">
                            <tr>
                                ...
                                <td>
                                	  <button type="button" class="btn btn-secondary" onclick="openDeleteModal(${course.id})">Delete</button>
                                	  
                                	  <a href="/StudentRegistrationMvc/student/seeStudents/${course.id}"><button type="button" class="btn btn-secondary">See</button></a>
...
<script>
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        ...
        fetch('deleteCourse/' + userIdToDelete, {
            method: 'GET'
        })
        .then(response => {
            if (response.ok) {
