...
<body>
    ...
    <div id="sub_content">
        ...
        <form:form action = "/StudentRegistrationMvc/student/addStudent" method="post" enctype="multipart/form-data" modelAttribute="student">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:input type="text" class="form-control" id="name"  path="name" placeholder="Enter Name" value="${name}"/>
                </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:input type="date" class="form-control"  id="dob" path="dob" value="${dob}"/>
                </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:input type="number" class="form-control" id="phone"   path="phone" placeholder="Enter Phone Number" value="${phone}"/>
                </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:input type="file" class="form-control" id="file" path="photo" value="${imageData}" accept="iamge/*" required="required"/>
